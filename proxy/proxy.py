...
_TG_RANGES = [
    ...
    (struct.unpack('!I', _socket.inet_aton('149.154.160.0'))[0],
     struct.unpack('!I', _socket.inet_aton('49.154.163.255'))[0]),

     (struct.unpack('!I', _socket.inet_aton('149.154.164.0'))[0],
     struct.unpack('!I', _socket.inet_aton('149.154.167.255'))[0]),

    (struct.unpack('!I', _socket.inet_aton('149.154.168.0'))[0],
     struct.unpack('!I', _socket.inet_aton('149.154.171.255'))[0]),

     (struct.unpack('!I', _socket.inet_aton('91.108.12.0'))[0],
     struct.unpack('!I', _socket.inet_aton('91.108.15.255'))[0])
]
